/*
  ...
  Features: Email + Password login, link to register, LTR layout, professional branding
*/
  ...
  const loginMutation = trpc.auth.login.useMutation({
    ...
    onError: err => {
      ...
      if (msg.includes("pending")) {
        toast.error("Account pending review", {
          description:
            "Your request is awaiting System Administrator approval.",
        });
        setLocation("/approve");
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-gradient-to-br from-slate-900 via-slate-800 to-slate-950 flex-col justify-between p-12">
        ...
        <div className="relative z-10">
          ...
          <p className="text-slate-400 text-sm leading-relaxed max-w-sm">
            A professional platform for managing industrial blind isolation
            across engineering projects, with controlled access, traceability,
          ...
          {[
            {
              ...
              desc: "Monitor every blind through its controlled lifecycle",
            },
            {
              icon: Shield,
              label: "Role-based access control",
              desc: "Apply precise permissions for every user and role",
            },
            {
              icon: Eye,
              label: "Operational reporting",
              desc: "Export- and print-ready project oversight",
            },
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-2xl p-8 shadow-2xl">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    dir="ltr"
                    className="pl-10 bg-slate-800 border-slate-700 text-white placeholder:text-slate-600 focus:border-cyan-500 focus:ring-cyan-500/20 h-11 rounded-xl"
                    required
                    autoComplete="email"
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    placeholder="••••••••"
                    dir="ltr"
                    className="pl-10 pr-10 bg-slate-800 border-slate-700 text-white placeholder:text-slate-600 focus:border-cyan-500 focus:ring-cyan-500/20 h-11 rounded-xl"
                    required
            ...
            <div className="text-center">
              ...
              <p className="text-xs text-slate-600 mt-2 leading-relaxed">
                Registration requests require System Administrator approval
                before activation.
              </p>
            </div>
          </div>
