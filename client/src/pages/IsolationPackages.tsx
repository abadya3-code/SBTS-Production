...
export default function IsolationPackages() {
  ...
  return (
    <div className="space-y-6">
      ...
      <CreatePackageDialog open={createOpen} projects={projectsQuery.data ?? []} onClose={() => setCreateOpen(false)} onCreated={async (id) => { setCreateOpen(false); setSelectedPackageId(id); await refresh(); }} />
